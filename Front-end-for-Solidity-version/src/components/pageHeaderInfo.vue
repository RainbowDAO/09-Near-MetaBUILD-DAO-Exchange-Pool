<template>
  <div class="dao-finance-header-box">
    ...
    <div class="dao-finance-header" v-show="daoInfo.name">
      ...
      <div class="rainbow-button create-proposal"
           @click="$router.push({name:'createProposal',params:{address:daoInfo.manage,vault:daoInfo.vault}})">
        Create Proposal
      </div>
      <div class="rainbow-button create" @click="$router.push({name:'createExchange'})">
        Create Vault
      </div>
      <div class="rainbow-button" @click="joinVault">
        JOIN
      </div>
    </div>
  </div>
